...
class UserInterfaceInit:
    def __init__(self, root):
      ...
      #  self.captureModeFrame = self.captureMode.initializeCaptureMode()
        ...
        self.dashboardFrame, \
        self.hCamera = self.dashboard.initializeDashboard(self.captureMode, self.captureMode.captureModeText)
...
def main():
   ...
   # captureModeFrame.place(in_=container, x=0, y=0, relwidth=1, relheight=1)
    ...
    b1 = Tk.Button(buttonframe, text="Dashboard", command=dashboardFrame.lift, font=("Courier", 9))
    b2 = Tk.Button(buttonframe, text="Capture Mode",
                   command=lambda: ui.captureMode.initializeCaptureMode(), font=("Courier", 9))
    b3 = Tk.Button(buttonframe, text="Sensor Mode", font=("Courier", 9))
